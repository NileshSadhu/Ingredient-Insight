            ...
            >
                {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                    <View style={styles.inputField}>
                        ...
                        <CustomInputs placeholder={'Nilesh N. Sadhu'} value={values.user}
                            onChangeText={handleChange('user')} onBlur={handleBlur('user')} />
                        {errors.user && touched.user && (
                            <Text style={[globalStyle.text, globalStyle.errorText]}>{errors.user}</Text>
                        )}
